...
const Products = () => {
    ...
    let following = Math.floor((Math.random() * 100) + 1);
    let followers = Math.floor((Math.random() * 10000) + 1);
        ...
        <div className='mx-auto'>
            <div>
                {/* <div className="card">
                    ...
                    <div className="title">Grapic Designer</div>
                    <div className="actions">
                        ...
                        <div className="follow-btn">
                            <button onClick={() => handleBtnClick('Following')}>{btnText}</button>
                        </div>
                    </div>
...

                {
                    profiles.map(profile => {
                        ...
                        <div
                            ...
                            <div className="title">{profile.profession}</div>
                            <div className="actions">
                                <div className="follow-info">
                                    <h2><a href="#"><span>{followers}</span><small>Followers</small></a></h2>
                                    <h2><a href="#"><span>{following}</span><small>Following</small></a></h2>
                            ...
                            <div className="desc">{profile.about}</div>
                        </div>
                    })
                }
            </div>
